...
if (ENVIRONMENT_IS_NODE) {
  ...
  // the (null)()` function.  This is only necessary for multi-environment
  // builds, `-sENVIRONMENT=node` emits a static import declaration instead.
  // TODO: Swap all `(null)()`'s with `import()`'s?
...
assert(INITIAL_MEMORY == 419430400, 'Detected runtime INITIAL_MEMORY setting.  Use -sIMPORTED_MEMORY to define wasmMemory dynamically');
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 419430400);
    updateMemoryViews();
